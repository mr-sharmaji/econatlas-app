const Map<String, String> metricExplanations = {
  ...
  'cash_from_operations':
      'Cash Flow from Operations (CFO) shows the cash generated by the company\'s core business activities. Positive CFO means the business is self-sustaining — it earns real cash from selling products/services. Negative CFO is a red flag unless the company is in an early growth phase.',
  'cash_from_investing':
      'Cash Flow from Investing (CFI) reflects money spent on or received from long-term assets like factories, equipment, and acquisitions. Negative CFI is normal for growing companies (they\'re investing). Positive CFI may mean the company is selling assets.',
  'cash_from_financing':
      'Cash Flow from Financing (CFF) shows money raised from or returned to investors and lenders — dividends, share buybacks, debt repayment, or new borrowings. Negative CFF often means the company is returning cash to shareholders (good sign for mature companies).',
  'compounded_sales_growth_3y':
